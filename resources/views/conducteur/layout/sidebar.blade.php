  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="{{ url('conducteur/') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['email/*']) }}">
        ...
        <div class="collapse {{ show_class(['email/*']) }}" id="email">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('conducteur/email/inbox') }}" class="nav-link {{ active_class(['email/inbox']) }}">Inbox</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('conducteur/email/read') }}" class="nav-link {{ active_class(['email/read']) }}">Read</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('conducteur/email/compose') }}" class="nav-link {{ active_class(['email/compose']) }}">Compose</a>
            </li>
          </ul>
        </div>
      </li>
