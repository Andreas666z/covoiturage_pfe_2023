...
Route::get('register', [login::class, 'registerForm'])
    ->name('register');
...
/*----------------------passager-------------------------------------------------*/
Route::prefix('passager')->middleware('passager')->group(function () {
    ...
    Route::group(['prefix' => 'email'], function () {
        Route::get('inbox', function () {
            return view('passager.pages.email.inbox');
        });
        Route::get('read', function () {
            return view('passager.pages.email.read');
        });
        Route::get('compose', function () {
            return view('passager.pages.email.compose');
        });
    });
...
/*----------------------conducteur-------------------------------------------------*/
Route::prefix('conducteur')->middleware('conducteur')->group(function () {
    ...
    Route::group(['prefix' => 'email'], function () {
        Route::get('inbox', function () {
            return view('conducteur.pages.email.inbox');
        });
        Route::get('read', function () {
            return view('conducteur.pages.email.read');
        });
        Route::get('compose', function () {
            return view('conducteur.pages.email.compose');
        });
    });
